    ...
    <section className=" overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <span className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 w-28 h-1.5 bg-gradient-to-r from-yellow-500 to-amber-500 rounded-full"></span>
        </motion.h2>

        <div className="relative">
          {/* Vertical Timeline */}
          <div className="absolute left-10 top-0 bottom-0 w-1 bg-gradient-to-b from-yellow-500 via-amber-300 to-amber-200 rounded-full"></div>
