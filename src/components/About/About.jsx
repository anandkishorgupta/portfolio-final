...
const About = () => {
  ...
  // Memoized paragraph text (optional)
  const paragraphText = useMemo(
    () =>
      `Nara Prasad Sitaula, born in Taplejung and 46 years old, is a distinguished business leader and entrepreneur with a Bachelor’s degree in Business Administration and extensive experience in management, energy, and cooperative sectors. He currently serves as the Chairman of Devshree Ventures Pvt. Ltd. and Devshree Multipurpose Cooperative, and as the Director of Niko Energy Limited. Additionally, he is the Managing Director of Waling Khurkhola Hydropower Ltd. and has previously served as a Director at Kohinoor Wires & Steel. With over 22 years of experience at LIC Nepal as an AM Agency Manager and 7 years of teaching experience at Roseboard School, he brings a strong combination of leadership and professional expertise. He is also an investor in prominent companies across hydropower, cement, equity funds, and hospitality sectors. Beyond his business ventures, Nara Prasad Sitaula is actively engaged in community service. He serves as the Chairman of Sitaula Sewa Samaj, Bhaktapur, and has previously held position as Director and currently serves as Advisor at Bhaktapur Jilla Baideshya Sahakari Sangh.`,
    []
  );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-10 items-start">
          ...
          <motion.div
            ...
            variants={textVariants}
          >
            <motion.p className="about-paragraph">{paragraphText}</motion.p>
          </motion.div>
        </div>
      </div>
    </motion.div>
